...
class TestCustomList(TestCase):
    def setUp(self):
        self.al = CustomList()
    def test_append__when_list_is_empty__expect_to_append_to_the_end(self):
        self.al = CustomList()
        self.al.append(1)
        values = list(self.al)
    ...
    def test_append__expect_to_return_the_end(self):
        result = self.al.append(1)
        self.assertEqual(self.al, result)

    def test_append__when_list_is_not_empty__expect_to_append_to_the_end(self):
        self.al = CustomList()
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
    ...
    def test_append__1024__expect_to_append_to_the_end(self):
    ...
    def test_extend__with_empty_iterable__expect_to_be_the_same(self):
        self.al.append(1)
        self.al.extend([])
    ...
    def test_extend__when_empty__expect_to_append_the_list(self):
        self.al.append(1)
        self.al.extend([1])
    ...
    def test_index__when_item_is_present__should_return_correct_index(self):
        [self.al.append(x) for x in range(15)]
    ...
    def test_index__when_item_is_not_present__should_raise(self):
        [self.al.append(x) for x in range(15)]
    ...
    def test_copy__expect_to_return_another_list_with_the_same_values(self):
        [self.al.append(x) for x in range(5)]
    ...
    def test_dictionize__when_not_even_elements_count__expect_correct_result(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_move__when_list_is_empty__expect_to_move_nothing(self):
        self.al.move(1)
        self.assertEqual([], list(self.al))

    def test_move__when_moving_1_element__expect_to_move_1_element_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_move__when_moving_3_elements_and_having_2_elements__expect_to_move_3_elements_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.move(3)
    ...
    def test_overbound__expect_to_return_mix_element(self):
        values = [x for x in range(15)]
        [self.al.append(x) for x in values]
    ...
    def test_sum__with_integers_only__expect_correct_return(self):
        self.al = CustomList()
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
    ...
    def test_sum__with_str__expect_correct_return(self):
        self.al = CustomList()
        self.al.append(1)
        self.al.append('2')
        self.al.append(3)
